...
//         const itemsResponse = await getLibraryItems();
//         const itemsWithAbbreviation = itemsResponse.map((item) => ({
//           ...item,
//           abbreviation: getAbbreviation(item.title),
//         }));
//         setItems(itemsWithAbbreviation);
...
//   // Filtrera och sortera artiklar baserat på vald kategori och sorteringsalternativ
//   const filteredItems = selectedCategory.id
//     ? items.filter((item) => item.categoryId === selectedCategory.id)
//     : items;
...
//       <div>
//         {user && (
//           <Link to="/library-items/new" className="btn btn-primary mb-2">
//             New Item
//           </Link>
//         )}
//       </div>
...
//         <select
//           value={sortOption}
//           onChange={(e) => setSortOption(e.target.value as "category" | "type")}
//         >
//           <option value="category">Sort by Category</option>
//           <option value="type">Sort by Type</option>
//         </select>
